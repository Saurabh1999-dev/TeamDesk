...
namespace TeamDesk.Migrations
{
    ...
    [Migration("20250811065947_update-new")]
            ...
            modelBuilder.Entity("TeamDesk.Models.Entities.Leave", b =>
                {
                    ...
                    b.HasIndex("StaffId")
                        .HasDatabaseName("IX_Leaves_StaffId");
                    ...
                    b.HasIndex("StaffId", "Status", "IsActive")
                        .HasDatabaseName("IX_Leaves_StaffId_Status_IsActive");
